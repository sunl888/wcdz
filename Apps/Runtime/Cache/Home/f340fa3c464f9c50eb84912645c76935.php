...
<title>图片新闻--<?php echo ($webInfo["sitename"]); ?></title>
...
<div class="listleft">
    ...
    <div class="details_right">
    	<h2><span>当前位置：<a href="/dygzz/index.php/Index/index">首页</a>>>图片新闻</span></h2>
        <p class="articletitle"><?php echo ($contentList["name"]); ?></p>
        <p class="articleData">
            <span>发布时间：<?php echo (date("Y-m-d",$contentList["addtime"])); ?></span>
            <span>访问量：<?php echo ($contentList["views"]); ?></span>
            <span>来源：<?php echo ($contentList["author"]); ?></span>
        </p>
        <div class="articleText">
            <?php echo ($contentList["content"]); ?>
