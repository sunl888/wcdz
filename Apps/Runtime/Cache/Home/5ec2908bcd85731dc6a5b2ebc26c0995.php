...
<title><?php echo ($classList["title"]); ?>--<?php echo ($webInfo["sitename"]); ?></title>
...
<div class="listleft">
    ...
    <div class="details_right">
    	<h2><span>当前位置：<a href="/dygzz/index.php/Index/index">首页</a>>><?php echo ($navigation); ?>>>正文</span></h2>
        <p class="articletitle"><?php echo ($classList["title"]); ?></p>
        <p class="articleData">
            <span>发布时间：<?php echo (date("Y-m-d",$classList["addtime"])); ?></span>
            <span>访问量：<?php echo ($classList["views"]); ?></span>
            <span>来源：<?php echo ($classList["source"]); ?></span>
        </p>
