...
<title>新闻图片--<?php echo ($webInfo["sitename"]); ?></title>
</head>
    ...
    <div class="contentleftBottom">
      ...
      <div class="content_right">
        <div class="top">
            ...
            <p>当前位置：新闻图片>>正文<a href="<?php echo U('Index/index');?>">首页</a></p>
        </div>
        <div class="bottom">
            <h2><?php echo ($pictureList["name"]); ?></h2>
            <p class="time"><span>发布时间：<?php echo (date("Y-m-d H:m",$pictureList["addtime"])); ?></span>
                <span>访问量:<i><?php echo ($pictureList["views"]); ?></i></span>
                <!--<span>来源：<?php echo ($contentList["source"]); ?></span>--></p>
            <div class="cont">
                <p><?php echo ($pictureList["content"]); ?></p>
            </div>
            <p class="writer">责任编辑:<?php echo ($pictureList["author"]); ?></p>
        </div> 
