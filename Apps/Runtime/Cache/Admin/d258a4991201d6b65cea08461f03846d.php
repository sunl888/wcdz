    ...
    <div class="page-content">
        ...
        <div class="col-sm-12">
			<div class="tabbable">
                ...
                <li><a href="/dygzz/admin.php/Partymember/termadd">添加班级</a></li>
				</ul>

				<div class="tab-content">

                    <div id="classify" class="tab-pane in active">						
                        <form action="/dygzz/admin.php/Link/termEdit" method="post" >
                        	<table class="table table-hover">
                            	<tr class="title background-blue">
                                	<th width="10%">ID</th>
                                  <th width="30%">班级ID</th>
                                    <th width="30%">班级名称</th>
	                            	<th width="30%" class="operate align-center">操作</th>                            	
                            	</tr>
                            	<?php if(is_array($classnameList)): foreach($classnameList as $key=>$classname): ?><tr>
                                      <td>#<?php echo ($key+1); ?></td>
  	                                	<td><?php echo ($classname["id"]); ?></td>
  	                                  <td><?php echo ($classname["classname"]); ?></td>
	                                	<td class="align-center"><a href="/dygzz/admin.php/Partymember/termedit/id/<?php echo ($classname["id"]); ?>/mw/<?php echo ($classname["mw"]); ?>">修改</a> |&nbsp;
                                        <a href="javascript:void(0);" onclick="return confirm('/dygzz/admin.php/Partymember/termdel/id/<?php echo ($classname["id"]); ?>','确定删除?');">删除</a>
