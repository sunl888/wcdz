        ...
        <div class="col-sm-12">
			<div class="tabbable">
				<ul class="nav nav-tabs">
                    ...
                    <li  class="active"><a href="#">修改寝室 </a></li>
				...
				<div class="tab-content">
					...
					<div  class="tab-pane in active">
                        ...
                        <form action = "/dygzz/admin.php/Domitory/edit/id/<?php echo ($DomitoryList["id"]); ?>" enctype="multipart/form-data" method = "post">
                                <input type="hidden" name="id" value="<?php echo ($DomitoryList["id"]); ?>"/>
                        	 <table class="table-form" >
                                <tr>
                                    <th class = "table-name" width="150" >寝室号:</th>
                                    <td>
                                        <input class="form-control input-sm wid-3" type="text" placeholder="" name="did" value="<?php echo ($DomitoryList["did"]); ?>">
                                    </td>                                
                                </tr>
                                <tr>
                                    <th>寝室长:</th>
                                    <td>
                                        <input class="form-control input-sm wid-3" type="text" placeholder="" value="<?php echo ($DomitoryList["leader"]); ?>" name="leader">
                                    </td>                                
                                </tr>
                                 <tr>
                                    <th>图片:</th>kuyjk
