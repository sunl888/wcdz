...
<html lang="zh-CN">
  <head>
    ...
    <link rel="stylesheet" href="/dygzz/Public/e8admin/default/css/e8.css">
  ...
  <body>
    	...
    	<div class="navbar-container">
            ...
            <div class="navbar-topmenu pull-left">
            	<ul class="list-inline topmenu">
            		<?php if(is_array($topMenuArr)): $i = 0; $__LIST__ = $topMenuArr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$topMenu): $mod = ($i % 2 );++$i; if($topMenu["id"] == $menuid): ?><li class="active"><a class="color-white" href="/dygzz/admin.php/<?php echo ($topMenu["controller"]); ?>/<?php echo ($topMenu["action"]); ?>/<?php echo ($topMenu["parameter"]); ?>"><?php echo ($topMenu["name"]); ?></a></li>
            			<?php else: ?>
            				<li><a class="color-white" href="/dygzz/admin.php/<?php echo ($topMenu["controller"]); ?>/<?php echo ($topMenu["action"]); ?>/<?php echo ($topMenu["parameter"]); ?>"><?php echo ($topMenu["name"]); ?></a></li><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                </ul>
            </div>
            	...
            	<ul class="list-inline usermenu">
                    <li class="user-info">
                        ...
                        <ul class="pop-usermenu pull-right dropdown-yellow dropdown-menu">
                            <li><a href="/dygzz/admin.php/Person/info" target="coniframe"><i class="fa fa-pencil fa-fw"></i> 修改个人信息</a></li>
                            <li><a href="/dygzz/admin.php/Person/pwd" target="coniframe"><i class="fa fa-pencil fa-fw"></i> 修改密码</a></li>
                            <li class="divider"></li>
                            <li><a href="/dygzz/admin.php/Public/logout"><i class="fa fa-sign-out fa-fw"></i> 退出登录</a></li>
						</ul>
                    </li>
                </ul>
            </div><!-- /.navbar-user -->
    ...
    <div class="e8-container">
    	<div class="left-content pull-left">
        	<div class="fast-operation">
                <a href="/dygzz/admin.php/Content/add" target="_blank" title="文章添加">
            ...
            <ul class="nav nav-list e8-nav list-unstyled pull-left">
            	<?php if(is_array($childMenuArr)): $i = 0; $__LIST__ = $childMenuArr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$childMenu): $mod = ($i % 2 );++$i;?><li>
                        <?php if($childMenu["url"] != '#'): ?><a href="/dygzz/admin.php/<?php echo ($childMenu["url"]); ?>" class="solid-line" target="coniframe">
                        <?php else: ?>
						...
						<?php if($childMenu["cmenu"] != 'null'): if(is_array($childMenu["cmenu"])): $i = 0; $__LIST__ = $childMenu["cmenu"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menu): $mod = ($i % 2 );++$i;?><li class="dotted-line">
                                    <?php if($menu["type"] != 2): ?><a href="/dygzz/admin.php/<?php echo ($menu["url"]); ?>" onclick="hideTree();" target="coniframe">
        ...
        <iframe class="right-content pull-left" name="coniframe" frameborder="0" scrolling="auto"  src="/dygzz/admin.php/Center/index"></iframe>
    ...
    <!--  页面初始化js文件  -->
    <!-- 监听div 大小改变插件 -->
    <script src="/dygzz/Public/e8admin/default/js/resize.js"></script>
