    ...
    <div class="page-content">
        ...
        <div class="col-sm-12">
			<div class="tabbable">
                ...
                <li class="active"><a href="#">添加班级</a></li>
				</ul>

				<div class="tab-content">
					<div class="tab-pane in active">
              <p class="title background-blue">班级详情</p>
                <form action = "/dygzz/admin.php/Partymember/termadd" method = "post"> 
                  <table class="table-form" >
                    <tr>
                      <th class = "table-name" width="100" >班级名称:</th>
                      <td>
                        <input class="form-control input-sm wid-3" type="text" placeholder="输入班级名称" name="classname">  
                      </td>                                
                    </tr>
                  </table>
