        ...
        <div class="col-sm-12">
			<div class="tabbable">
				<ul class="nav nav-tabs">
                    ...
                    <li  class="active"><a href="#">查看先进人物 </a></li>

                </ul>
				</ul>

				<div class="tab-content">
				<form action="/dygzz/admin.php/Advance/index" method="post">
					<div  class="tab-pane in active">
						<p class="title background-blue">查看先进人物</p>
                        	 <table class="table-form" >
                                ...
                                <tr>
                                    <th class = "table-name" width="150" >班级:</th>
                                    <td>
                                        <input class="form-control input-sm wid-3" type="text" placeholder="" name="classname" value="<?php echo ($studentList["classname"]); ?>">
                                    </td>                                
                                </tr>
                                <tr>
                                    <th>学号:</th>
