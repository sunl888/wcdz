        ...
        <div class="col-sm-12">
			<div class="tabbable">
				<ul class="nav nav-tabs">
                    ...
                    <li class="active"><a href="/dygzz/admin.php/Picture/add">添加图片</a></li>
<!--                    <li><a href="/dygzz/admin.php/Picture/term">分类管理</a></li>
				...
				<div class="tab-content">
					...
					<div  class="tab-pane in active">
                      ...
                      <form action = "/dygzz/admin.php/Flowimg/add" enctype="multipart/form-data"  method = "post">
