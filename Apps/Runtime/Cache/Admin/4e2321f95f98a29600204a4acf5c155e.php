...
<html lang="zh-CN"><head>
  ...
  <body>
   <form action="/dygzz/admin.php/Content/edit" method="post"  enctype="multipart/form-data">
        ...
        <div class="col-md-10 c-l">
           ...
           <table class="table-form">
             ...
             <tr>
             	<th width="80">标题</th>
                <td>
                <input type="text" class="form-control input-sm wid-4 inp-bg-1" value="<?php echo ($content["title"]); ?>" name="title" id="title"/>
				...
				<span>还可以输入111个字符</span>
                </td>
             </tr>
             <tr>
             	<th>关键词</th>
                <td>
                	<input type="text" class="form-control input-sm wid-3"  name="keywords" value="<?php echo ($content["keywords"]); ?>"/>
             ...
             <tr>
             	<th>摘要</th>
                <td>
                	<textarea class="form-control input-sm wid-100" rows="2" name="description"> <?php echo ($content["description"]); ?></textarea>
                	<span>还可以输入255个字符</span>
                </td>
             </tr>
             <tr>
             	<th>来源</th>
                <td>
                	<input type="text" class="form-control input-sm wid-3" name="source" value="<?php echo ($content["source"]); ?>"/>
                </td>
             </tr>
             <th>作者</th>
                    <td>
                      <input type="text" class="form-control input-sm wid-3" name="author" value="<?php echo ($content["author"]); ?>"/>
                    </td>
             </tr>
             <tr>
                ...
                <td>
                    <div class="wid-100">
                        <script id="editor" type="text/plain" style="width:100%;height:300px;" name="content"><?php echo ($contentdata["content"]); ?></script>
                    </div>
        		...
        		<table class="table-form">
                    ...
                    <tr>
                        ...
                        <div class="img-upload wid-100">
                        	<p>
                        	<img class="img-circle" id="photo" src="<?php echo ($content["thumb"]); ?>" alt="<?php echo ($content["title"]); ?>"></p>
                    ...
                    <tr><td>发布时间</td></tr>
                    <tr><td>
                    	<input class="form-control input-sm" id="datetimepicker" type="text" name="addtime" value="<?php echo ($content["addtime"]); ?>"/>
                    </td></tr>
                    <tr>
                    	<td>内容模板</td>
                    </tr>
                    ...
                    <tr>
                    	<td>
                        	<input class="form-control input-sm" type="text" name="url" value="<?php echo ($content["url"]); ?>"/>
                        	<?php if($content["islink"] == 1): ?><input type="checkbox"  name="islink" value="1" checked="checked"/><span class="checkbox-span color-red">外部链接</span>
                            <?php else: ?>
                            	<input type="checkbox"  name="islink"  value="1"/><span class="checkbox-span color-red">外部链接</span><?php endif; ?>
                            	
                        </td>
                    </tr>
                    <tr><td>文章排序</td></tr>
                    <tr><td>
                    	<input class="form-control input-sm wid-1" type="text"  name="sort" value="<?php echo ($content["sort"]); ?>" />
                    </td></tr>
                </table>
            </div>
        </div><!-- /.c-r -->
