                         ...
                         <form action="/wcdz/admin.php/Comment/index" method="post">
                            <div style="padding:5px 0;">    
                                <div style="padding: 5px 0;">    
                                 ...
                                 <span>关键字：</span>
                                <input type="text" name="name" class="form-control input-sm wid-2" value="点击输入姓名关键字"onfocus="if (value =='点击输入姓名关键字'){value =''}"onblur="if (value ==''){value='点击输入姓名关键字'}"/>&nbsp;&nbsp;
                                <select name="status" class="form-control input-sm wid-1">
                                    <option value="null">&nbsp;&nbsp分类</option>
                        ...
                        <form action="/wcdz/admin.php/Comment/index" method="post">
                            <table class="table table-hover">
                                ...
                                <?php if(is_array($commentList)): foreach($commentList as $key=>$comment): ?><tr>
                                    <td><input type="checkbox" name="id" value="<?php echo ($comment["id"]); ?>"/></td>
                                    <td>#<?php echo ($key+1); ?></td>
                                    <td><?php echo ($comment["name"]); ?></td>
                                    <td><?php echo (subtitle($comment["comment"],20,0)); ?></td>
                                    <td><?php echo ($comment["email"]); ?></td>
                                    <td><?php echo (date("Y-m-d",$comment["stutime"])); ?></td>
                                    <td><?php echo ($comment["sta"]); ?></td>
