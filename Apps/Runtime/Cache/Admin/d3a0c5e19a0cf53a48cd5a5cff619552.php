                        ...
                        <form action = "/wcdz/admin.php/Partymember/add" enctype="multipart/form-data"  method = "post">
                        	 <table class="table-form" >
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="" method="">
                                            <input name="status" type="radio" value="0" checked/>正式党员&nbsp;&nbsp;&nbsp;
                                            <input name="status" type="radio" value="1"/>预备党员
                                        </form>
                                    </td>                                
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="form-control input-sm wid-3" name="isextro">
                                            <option value="1" >------优秀党员------</option>
                                            <option value="0" >------非优秀党员------</option>
                                        </select>
                                    </td>                                
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <th>获奖情况:</th>
                                    <td>
                                            <textarea  class="form-control" style="height:90px;" name="prize"></textarea>
                                    </td>
                                ...
                                <tr>
                                    <th>个人简介:</th>
                                    <td>
                                            <textarea  class="form-control" style="height:90px;" name="introduction"></textarea>
                                    </td>
