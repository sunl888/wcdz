			...
			<div class="tabbable">
				...
				<div class="tab-content">
                  ...
                  <div  class="tab-pane  in active">
                    <form action="__APP/Config/master" method="post">
                       
                        <p class="title background-blue">错误设置</p>
                        <table  class="table-form">
                            <tr>
                                <th class = "table-name" width="150" >显示错误信息:</th>
                                <td>
                                    <label class="radio-inline">
                                    	<input type="radio" name="inlineRadioOptions" id="inlineRadio" value="option1" checked> 开启
                                    </label>
                                    <label class="radio-inline">
                                   		<input type="radio" name="inlineRadioOptions" id="inlineRadio" value="option2"> 关闭
                                	</label>
                                </td>
                            </tr>
                            <tr>
                                <th >错误显示信息:</th>
                                <td>
                                    <input class="form-control input-sm wid-2" type="text" name="username"   value="<?php echo ($config[""]); ?>" placeholder=""/>
                                </td>
                            </tr>
                            <tr>
                                <th >错误指定页面:</th>
                                <td>
                                    <input class="form-control input-sm wid-2" type="text" name="username"   value="<?php echo ($config[""]); ?>" placeholder=""/>
                                    <span >例如：http://www.abc3210.com/error.html</span>
                         		</td>
                            </tr>
                        </table>
