        ...
        <div class="col-sm-12">
			<div class="tabbable">
				<ul class="nav nav-tabs">
                    ...
                    <li  class="active"><a href="#">查看党员信息 </a></li>
				...
				<form action="/dygzz/admin.php/Partymember/index" method="post">
					<div  class="tab-pane in active">
						<p class="title background-blue">查看党员信息</p>
                        	 <table class="table-form" >
                                ...
                                <tr>
                                 ...
                                 <tr>
                                        ...
                                        <td>
                                            <textarea  class="form-control" style="height:90px;" name="action" ><?php echo ($studentList["prize"]); ?></textarea>
                                        </td>
                                </tr> 
                                <tr>
                                    <th>个人简介:</th>
