        ...
        <div class="col-sm-12">
			<div class="tabbable">
				<ul class="nav nav-tabs">
                    ...
                    <li ><a href="/dygzz/admin.php/Advance/add">添加先进人物 </a></li>
                    <li  class="active"><a href="#">修改先进人物 </a></li>
				...
				<div class="tab-content">
					...
					<div  class="tab-pane in active">
						<p class="title background-blue">修改先进人物</p>
                        <form action = "/dygzz/admin.php/Advance/edit/id/<?php echo ($studentList["id"]); ?>" enctype="multipart/form-data"  method = "post">
                        	 ...
                        	 <table class="table-form" >
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="form-control input-sm wid-3" name="cid">
                                            ...
                                            <?php if(is_array($classnameList)): foreach($classnameList as $key=>$classname): ?><option value="<?php echo ($classname["id"]); ?>" <?php echo ($classname["selected"]); ?>><?php echo ($classname["classname"]); ?></option><?php endforeach; endif; ?>
                                        </select>
                                    </td>                                
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <select class="form-control input-sm wid-3" name="status">
                                            <option value="0" <?php echo ($studentList["zsele"]); ?> >正式党员</option>
                                            <option value="1" <?php echo ($studentList["ysele"]); ?> >预备党员</option>
                                            <option value="2" <?php echo ($studentList["gsele"]); ?> >共青团员</option>
                                        </select>
                                    </td>                               
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <th>获奖情况:</th>
                                    <td>
                                            <textarea  class="form-control" style="height:90px;width:400px;" name="prize" ><?php echo ($studentList["prize"]); ?></textarea>
                                    </td>                          
                                </tr>  
                                <tr>
                                    <th>个人简介:</th>
                                    <td>
                                            <textarea  class="form-control" style="height:90px;width:400px;" name="introduction" ><?php echo ($studentList["introduction"]); ?></textarea>
                                    </td>
